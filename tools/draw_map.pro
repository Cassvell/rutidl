...
pro map
  ...
  sjg = obscoord('sjg')
  cgPlotS, -sjg.longeo, sjg.latgeo, psym = 8, symsize = 4, color = 'Blue', thick = 12
  cgText, -sjg.longeo, sjg.latgeo * 1.1, 'SJG', alignment = 0.5

  gui = obscoord('gui')
  cgPlotS, -gui.longeo, gui.latgeo, psym = 8, symsize = 4, color = 'magenta', thick = 12
  cgText, -gui.longeo, gui.latgeo * 1.1, 'GUI', alignment = 0.5

  tam = obscoord('tam')
  cgPlotS, tam.longeo, tam.latgeo, psym = 8, symsize = 4, color = 'forest green', thick = 12
  cgText, tam.longeo, tam.latgeo * 1.1, 'TAM', alignment = 0.5

  jai = obscoord('jai')
  cgPlotS, jai.longeo, jai.latgeo, psym = 8, symsize = 4, color = 'red', thick = 12
  ...
  bmt = obscoord('bmt')
  cgPlotS, bmt.longeo, bmt.latgeo, psym = 8, symsize = 4, color = 'Blue', thick = 12
  ...
  kak = obscoord('kak')
  cgPlotS, kak.longeo, kak.latgeo, psym = 8, symsize = 4, color = 'magenta', thick = 12
  cgText, kak.longeo, kak.latgeo * 1.05, 'KAK', alignment = 0.5

  hon = obscoord('hon')
  cgPlotS, hon.longeo, hon.latgeo, psym = 8, symsize = 4, color = 'forest green', thick = 12
