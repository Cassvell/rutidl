...
COMPILE_OPT idl2, HIDDEN
    ...
    READCOL, file_name, event, ddyn_lfc, ddyn_hfc,  ddyn_lfcpick, ddyn_hfcpick,  ddyn_h1, dp2_lfc, DELIMITER= '  ',$
    FORMAT='I,F,F,F,F,F'
    
    idx = gs_event-1
    
    
    info = {event : 0 , ddyn_lfc : 0.0, ddyn_hfc : 0.0, ddyn_lfcpick : 0.0, ddyn_hfcpick : 0.0, ddyn_h1 : 0.0, dp2_lfc : 0.0}
