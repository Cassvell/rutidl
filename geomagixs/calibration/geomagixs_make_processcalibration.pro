...
;2022 08 01 00:00  -0441.379 -1584.757 00601.281 0275.363 0248.355
;2022 08 01 00:05  00103.604 -0395.440 00384.367 0248.515 0227.888
;I4  XI2XI2XI2XI22X       F9X
...
PRO geomagixs_make_processcalibration, initial, final, STATION=station, $
                                              ...
                                              FORCE_ALL=force_all, $
                                              H=h, D=d, Z=z, T=t, $
                                              OFFSET_TS=offset_ts, OFFSET_TC=offset_tc, $
...
;##############################################################################
        ...
        IF N_ELEMENTS(offset_ts) EQ 0 THEN offset_ts=0.
        IF N_ELEMENTS(offset_tc) EQ 0 THEN offset_tc=0.
        ;print, offset_tc
;##############################################################################
; initializing dates and hours
;##############################################################################
...
LOADCT, /SILENT, 39
        ...
        avrg_period = 60.*72.
        PLOT, time_array[magnetic_indexes]/(24*60), auxiliar_magnetic_data[magnetic_indexes].H-H_base, Xstyle=1, $
        ...
        OPLOT, time_array[magnetic_indexes]/(24*60), smooth(auxiliar_magnetic_data[magnetic_indexes].H-H_base, avrg_period, /EDGE_TRUNCATE), color=254,thick=2; SMOOTH( y, 24*60 )
        ...
        OPLOT, time_array[magnetic_indexes]/(24*60), smooth(station_magnetic_data[magnetic_indexes].H-H_base, avrg_period, /EDGE_TRUNCATE), color=50,thick=2
        ...
        PLOT, time_array[magnetic_indexes]/(24*60), auxiliar_magnetic_data[magnetic_indexes].Z-Z_base, Xstyle=1, $
              color=0, background=1 , Title='Z [nT] - Auxiliar(red) & Station(blue)', /NODATA, CHARSIZE=2., YRANGE=[Y_min, Y_max], XRANGE=[X_min, X_max]
        ...
        OPLOT, time_array[magnetic_indexes]/(24*60), smooth(auxiliar_magnetic_data[magnetic_indexes].Z-Z_base, avrg_period, /EDGE_TRUNCATE), color=254,thick=2
        OPLOT, time_array[magnetic_indexes]/(24*60), smooth(station_magnetic_data[magnetic_indexes].Z-Z_base, avrg_period, /EDGE_TRUNCATE), color=50,thick=2
        ...
        PLOT, time_array[magnetic_indexes]/(24*60), auxiliar_magnetic_data[magnetic_indexes].D-D_base, Xstyle=1, $
              color=0, background=1 , Title='D [Deg] - Auxiliar(red) & Station(blue)', /NODATA, CHARSIZE=2., YRANGE=[Y_min, Y_max], XRANGE=[X_min, X_max]
        ...
        OPLOT, time_array[magnetic_indexes]/(24*60), smooth(auxiliar_magnetic_data[magnetic_indexes].D-D_base, avrg_period, /EDGE_TRUNCATE), color=254,thick=2
        OPLOT, time_array[magnetic_indexes]/(24*60), smooth(station_magnetic_data[magnetic_indexes].D-D_base, avrg_period, /EDGE_TRUNCATE), color=50,thick=2
...
;GOTO, jump
        ...
        PLOT, time_array[magnetic_indexes]/(24*60), auxiliar_voltage_data[magnetic_indexes].H, Xstyle=1, $
              color=0, background=255 , Title='H [mV] - Auxiliar(red) & Station(blue)', /NODATA, CHARSIZE=2., YRANGE=[Y_min, Y_max], XRANGE=[X_min, X_max]
        ...
        OPLOT, time_array[magnetic_indexes]/(24*60), smooth(auxiliar_voltage_data[magnetic_indexes].H, avrg_period, /EDGE_TRUNCATE), color=254,thick=2
        OPLOT, time_array[magnetic_indexes]/(24*60), smooth(station_voltage_data[magnetic_indexes].H, avrg_period, /EDGE_TRUNCATE), color=50,thick=2
        ...
        PLOT, time_array[magnetic_indexes]/(24*60), auxiliar_voltage_data[magnetic_indexes].Z, Xstyle=1, $
              color=0, background=255 , Title='Z [mV] - Auxiliar(red) & Station(blue)', /NODATA, CHARSIZE=2., YRANGE=[Y_min, Y_max], XRANGE=[X_min, X_max]
        ...
        OPLOT, time_array[magnetic_indexes]/(24*60), smooth(auxiliar_voltage_data[magnetic_indexes].Z, avrg_period, /EDGE_TRUNCATE), color=254,thick=2
        OPLOT, time_array[magnetic_indexes]/(24*60), smooth(station_voltage_data[magnetic_indexes].Z, avrg_period, /EDGE_TRUNCATE), color=50,thick=2
        ...
        PLOT, time_array[magnetic_indexes]/(24*60), auxiliar_voltage_data[magnetic_indexes].D, Xstyle=1, $
              color=0, background=255 , Title='D [mV] - Auxiliar(red) & Station(blue)', /NODATA, CHARSIZE=2., YRANGE=[Y_min, Y_max], XRANGE=[X_min, X_max]
        ...
        OPLOT, time_array[magnetic_indexes]/(24*60), smooth(auxiliar_voltage_data[magnetic_indexes].D, avrg_period, /EDGE_TRUNCATE), color=254,thick=2
        OPLOT, time_array[magnetic_indexes]/(24*60), smooth(station_voltage_data[magnetic_indexes].D, avrg_period, /EDGE_TRUNCATE), color=50,thick=2
jump:
        ...
        ;t_max = MAX(time_array[magnetic_indexes]/(24*60))
        ;t_min = MIN(time_array[magnetic_indexes]/(24*60))
       
        PLOT, time_array[magnetic_indexes]/(24*60), station_magnetic_data[magnetic_indexes].F-auxiliar_magnetic_data[magnetic_indexes].F, Xstyle=1, $
              color=0, background=1 , Title='F [nT] - Daily(blue) & direct(red) differences', /NODATA, CHARSIZE=2., YRANGE=[Y_min, Y_max], XRANGE=[X_min, X_max]
        ...
        OPLOT, time_array[magnetic_indexes]/(24*60), smooth(station_magnetic_data[magnetic_indexes].F-auxiliar_magnetic_data[magnetic_indexes].F, avrg_period, /EDGE_TRUNCATE), color=50,thick=2
        ...
        PLOT, time_array[magnetic_indexes]/(24*60), 0.15*(auxiliar_voltage_data[magnetic_indexes].Ts-250.)+25., Xstyle=1, $
              color=0, background=1 , Title='Tsensor -daily- [C Deg] - Auxiliar(red) & Station(blue)', /NODATA, CHARSIZE=2., YRANGE=[Y_min, Y_max], XRANGE=[X_min, X_max]
        OPLOT, time_array[magnetic_indexes]/(24*60), smooth(0.15*(auxiliar_voltage_data[magnetic_indexes].Ts-250.)+25., avrg_period, /EDGE_TRUNCATE), color=254,thick=2
        OPLOT, time_array[magnetic_indexes]/(24*60), smooth(0.15*(station_voltage_data[magnetic_indexes].Ts-250.)+25., avrg_period, /EDGE_TRUNCATE), color=50,thick=2
        ...
        PLOT, time_array[magnetic_indexes]/(24*60), 0.15*(auxiliar_voltage_data[magnetic_indexes].Tc-250.)+25., Xstyle=1, $
              color=0, background=1 , Title='Tcontrol -daily- [C Deg] - Auxiliar(red) & Station(blue)', /NODATA, CHARSIZE=2., YRANGE=[Y_min, Y_max], XRANGE=[X_min, X_max]
        OPLOT, time_array[magnetic_indexes]/(24*60), smooth(0.15*(auxiliar_voltage_data[magnetic_indexes].Tc-250.)+25., avrg_period, /EDGE_TRUNCATE), color=254,thick=2
        OPLOT, time_array[magnetic_indexes]/(24*60), smooth(0.15*(station_voltage_data[magnetic_indexes].Tc-250.)+25., avrg_period, /EDGE_TRUNCATE), color=50,thick=2
