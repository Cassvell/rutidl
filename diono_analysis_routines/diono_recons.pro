pro diono_recons, date_i, date_f, station_code
  ...
  dp2vsQ, diono[WindowI : windowF], asymH[WindowI : windowF], dp2[WindowI : windowF], $
  ...
  cgPlot, date_time, abs(d_asym), xticks = file_number, xminor = 8, background = 'white', $
    ...
    position = [0.12, 0.51, 0.92, 0.92], xstyle = 5, ystyle = 5, xtickformat = ['LABEL_DATE'], xtickunits = ['day'], $
  ...
  cgPlot, date_time, tec_index, xticks = file_number, xminor = 8, background = 'white', $
    color = 'black', charsize = 1.6, charthick = chr_thick1, $
    position = [0.12, 0.09, 0.92, 0.49], xstyle = 5, ystyle = 5, xtickformat = ['LABEL_DATE'], xtickunits = ['day'], $
    xticklayout = 1, xtickinterval = 1, yrange = [down, up], /noerase, /nodata
  ...
  cgOPlot, [!x.crange[0], !x.crange[1]], [0, 0], color = 'black', linestyle = 2, thick = 2
