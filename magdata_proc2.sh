...
declare -a st=("BMT" "BOU" "BRD" "BSL" "CKI" "CYG" "GUI" "HBK" "IPM" "KAK" "KDU" "KMH" "PIL" "SJG" "TAM" "TDC" "TUC" "HON" "KNY" "JAI" "LZH" "ABG" "MLT" "QSB")
...
declare -a st_name=("bmt" "bou" "brd" "bsl" "cki" "cyg" "gui" "hbk" "ipm" "kak" "kdu" "kmh" "pil" "sjg" "tam" "tdc" "tuc" "hon" "kny" "jai" "lzh" "abg" "mlt" "qsb")
