...
;*** normalize by scale
	...
	wave_phase = ATAN(IMAGINARY(cross_wavelet),FLOAT(cross_wavelet))
	;wave_coher = (ABS(cross_wavelet)^2)/(power1*power2 > 1E-9)
	wave_coher = (ABS(cross_wavelet)) ;al no elevarse al cuadrado ni normalizarse, se trata de la amplitud.
